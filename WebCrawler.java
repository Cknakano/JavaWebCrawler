 ...
 * Web crawlers that searches through a given links in BFS and DFS fashion. 
 * Outputs desired number of links found within the searches and displays them back into console.
 * Run Configurations: Website Link and then number
 * @author Christine Nakano, Help from Kanai
 *
 */
